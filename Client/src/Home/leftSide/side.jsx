      ...
      <div className=" flex-col gap-4 hidden sm:hidden md:hidden lg:flex">
        ...
        <div className="p-1  h-[580px]  shadow-2xl flex flex-col gap-[1rem] overflow-x-clip">
          <div className="flex flex-col  justify-center items-center gap-[1rem]">
            ...
            />
            <img
              className="border-1 bg-slate-50 w-[7rem] h-[7rem] top-[14.7rem] absolute rounded-[50%] shadow-2xl"
              src={
                user.profilePicture
          ...
          <div>
            <div className=" m-auto w-[80%] border-[1px]">
              <hr />
            </div>
            ...
            <div className=" m-auto w-[80%] border-[1px] mb-3">
              <hr />
            </div>
          </div>
